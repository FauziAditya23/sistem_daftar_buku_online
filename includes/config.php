...
function db_connect()
{
    ...
    if (!$conn) {
        ...
        throw new RuntimeException("Database connection failed: $err. Ensure MySQL
is running and credentials in includes/config.php are correct. If you use XAMPP,
start MySQL via the XAMPP control panel or run
