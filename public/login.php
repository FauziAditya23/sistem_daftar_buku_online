...
<script>
    ...
    (function () {
        ...
        if (typeof Storage !== 'undefined' && sessionStorage.getItem('just_logged_out') ===
            'true') {
        ...
        <div class="card login-card">
            ...
            <form class="card-form" method="post" action="index.php?page=login_proses" novalidate>
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="password-toggle" id="togglePassword" ariapressed="false"
                        ...
                        <svg class="icon-hide" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                            <path d="M2 2l20 20M17 17A10.9 10.9 0 0 1 12 19c-7 0-11-7-11-7a21.37 21.37 0 0 1 5-5"></path>
                        </svg>
                ...
                (function () {
                    ...
                    form && form.addEventListener('submit', function () {
                        if (submitBtn) {
                            ...
                            submitBtn.innerHTML = '<span class="spinner" role="status" ariahidden="true"></span>Masuk...';
                        }
                        if (cancelBtn) {
