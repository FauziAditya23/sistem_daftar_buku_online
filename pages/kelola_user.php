                ...
                <?php else: ?>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <span class="user-level <?php echo
                            ...
                            <td>
                                <?php if (!empty($user['user_foto'])): ?>
                                    <img src="<?php echo htmlspecialchars($user['user_foto']);
                                    ?>" alt="Foto <?php echo
                                        htmlspecialchars($user['nama_lengkap']); ?>" class="user-photo">
                                <?php else: ?>
                            ...
                            <td>
                                <a href="index.php?page=form_user&id=<?php echo
                                    $user['user_id']; ?>" class="btn btn-success">Edit</a>
