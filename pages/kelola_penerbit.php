        ...
        <div class="crud-header">
            ...
            <div>
                <a href="index.php?page=dashboard" class="btn btn-secondary">← Kembali ke
                    Dashboard</a>
                <a href="index.php?page=form_penerbit&action=add" class="btn btn-primary">Tambah
                    Penerbit</a>
            </div>
        </div>
                ...
                <?php else: ?>
                    <?php foreach ($publishers as $publisher): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo htmlspecialchars($publisher['penerbit_nama']);
                                ?>
                            </td>
                            <td>
                                <a href="index.php?page=form_penerbit&action=edit&id=<?php echo
                                    htmlspecialchars($publisher['penerbit_id']); ?>" class="btn btn-success">Edit</a>
                                <button onclick="deletePublisher('<?php echo
                                    htmlspecialchars($publisher['penerbit_id']); ?>')" class="btn btn-danger">Hapus</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
