    ...
    <div class="crud-container">
        <div class="crud-header">
            ...
            <div>
                ...
                <a href="index.php?page=form_kategori&action=add" class="btn btnprimary">Tambah Kategori</a>
            </div>
        </div>
                ...
                <?php else: ?>
                    <?php foreach ($categories as $category): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo htmlspecialchars($category['kategori_nama']);
                                ?>
                            </td>
                            <td>
                                <a href="index.php?page=form_kategori&action=edit&id=<?php echo
                                    htmlspecialchars($category['kategori_id']); ?>" class="btn btn-success">Edit</a>
                                <a href="#" onclick="openDeleteModal('<?php echo
                                    htmlspecialchars($category['kategori_id']); ?>', '<?php echo
                                     htmlspecialchars($category['kategori_nama']); ?>')" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post" id="deleteForm">
                    ...
                    <button type="button" onclick="closeDeleteModal()" class="btn btnsecondary">Batal</button>
                </form>
            </div>
        </div>
    </div>
