        ...
        <div class="dashboard-header">
            ...
            <?php else: ?>
                <div class="user-avatar"
                    style="background: #007bff; display: flex; alignitems: center; justify-content: center; color: white; font-size: 24px; font-weight: bold;">
                    <?php echo strtoupper(substr($nama_lengkap, 0, 1)); ?>
                </div>
            <?php endif; ?>
            <div class="user-info">
                <h2>Selamat datang, <?php echo htmlspecialchars($nama_lengkap); ?>!</h2>
                <p>Level: <strong><?php echo htmlspecialchars($user_level); ?></strong> |
                    Username: <?php echo htmlspecialchars($username); ?></p>
            </div>
        </div>
        <!-- Dashboard Content -->
        <div class="dashboard-content">
            <?php if ($user_level === 'Administrator'): ?>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <h3 id="total-buku">
                            <?php echo htmlspecialchars($total_buku);
                            ?>
                        </h3>
                        <p>Total Buku</p>
                    </div>
                    <div class="stat-card">
                        <h3 id="total-penerbit"><?php echo
                            htmlspecialchars($total_penerbit); ?></h3>
                        <p>Total Penerbit</p>
                    </div>
                    <div class="stat-card">
                        <h3 id="total-pengarang"><?php echo
                            htmlspecialchars($total_pengarang); ?></h3>
                        <p>Total Pengarang</p>
                    </div>
                </div>
            ...
            <div class="recent-activity">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        ...
                        <span class="activity-time"><?php echo date('H:i:s'); ?> hari
                            ini</span>
                    </li>
                    <li class="activity-item">
